...
def training_pipeline(config):
 ...
 # Set device
    ...
    # Make dataset
    train_set = SpecFeatDataset(config['tr_manifest_path'], config['train_metadata'], config['labels_map'], config['audio_config'])
    val_set = SpecFeatDataset(config['val_manifest_path'], config['val_metadata'], config['labels_map'], config['audio_config'])
    test_set = SpecFeatDataset(config['eval_manifest_path'], config['test_metadata'], config['labels_map'],config['audio_config'])
